...
export default async function AdminDashboard() {
  ...
  const [applications, totalApplications, pending, confirmed, rejected, openBatches, fullBatches, batchTotals, students] = await Promise.all([
    ...
    db.batch.count({ where: { status: "OPEN", course: { active: true } } }),
